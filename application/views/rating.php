...
1. <a href="<?php echo base_url() . 'js/rating.js' ?>" target="_blank">rating.js</a><br/>
2. <a href="rating.css">rating.css</a><br/>
3. Images: <a href="<?php echo base_url() . 'img/star.gif' ?>">star.gif</a>, <a href="<?php echo base_url() . 'img/delete.gif' ?>">delete.gif</a><br/>
...
<div id="rate2" class="rating">&nbsp;<div class="cancel"><a href="#0">Cancel Rating</a></div><div class="star on"><a href="#1" style="width: 100%;">1</a></div><div class="star on"><a href="#2" style="width: 100%;">2</a></div><div class="star"><a href="#3" style="width: 100%;">3</a></div><div class="star"><a href="#4" style="width: 100%;">4</a></div><div class="star"><a href="#5" style="width: 100%;">5</a></div></div>
